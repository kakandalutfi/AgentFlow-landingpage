        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1 flex flex-col gap-4">
            ...
            <p className="text-sm text-muted-foreground">
              Build AI agents that work while you sleep. Automate workflows, scale operations, and ship faster.
            </p>
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link href="#" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Templates</Link>
          </div>
